...
function UPnPVideoManager(id) {
    ...
    this.load = function(deviceUid, containerId) {
        ...
        upnp.backend.call(this.deviceUid, 'searchVids', 'ObjectID=' + this.containerId, function(res) {
            ...
            if(res.NumberReturned > 0) {
                ...
                for(var i in files) {
                    ...
                    upnp.videomanager.files[file.id] = new UPnPFile(file);
                }
            }
